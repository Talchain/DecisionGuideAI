...
export type Draft = { id: string; title: string; why: string; suggestion_confidence: number; parse_json: Record<string, unknown>; parse_json_hash: string; critique: CritiqueItem[]; threshold_crossings?: Array<{ from: string|number; to: string|number }>; fork_suggested?: boolean; fork_labels?: string[] }
...
export function postDraftFlows(body: { seed: number; parse_text: string; context?: Record<string, unknown>; board_feedback?: Record<string, unknown> }) {
