...
import { useAnalysisMayRun, useBoundAdmissionReasonCodes } from '../hooks/useAnalysisReady'
...
export const ConversationPanel = memo(function ConversationPanel({
  ...
  const runGateResult = useMemo(() => canRunAnalysisUtil({
    ...
    draftStreamPhase,
    readinessStale,
  }), [graphHealth, readiness, analysisReadiness, analysisMayRun, admissionReasonCodes, hasBlockers, nodeCount, isAnalysisRunning, heldOn, draftStreamPhase, readinessStale])
