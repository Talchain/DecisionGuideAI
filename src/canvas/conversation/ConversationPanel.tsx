...
import { useAnalysisMayRun, useBoundAdmissionWording } from '../hooks/useAnalysisReady'
...
export const ConversationPanel = memo(function ConversationPanel({
  ...
  const admissionWording = useBoundAdmissionWording()
  const runGateResult = useMemo(() => canRunAnalysisUtil({
    ...
    draftStreamPhase,
    readinessStale,
  }), [graphHealth, readiness, analysisReadiness, analysisMayRun, admissionWording, hasBlockers, nodeCount, isAnalysisRunning, heldOn, draftStreamPhase, readinessStale])
