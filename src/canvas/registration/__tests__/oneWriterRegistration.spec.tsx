 ...
 * 13. OW-1: an applied receipt LATCHES the scenario (rule 2) — then nothing is
 ...
 *   has NOT latched (`mountUnlatchedStarter`, §13) — in the two deferral cases.
 *
...
// ═══════════════════════════════════════════════════════════════════════════
// 13. OW-1 — AN APPLIED RECEIPT LATCHES THE SCENARIO (the one-writer contract,
...
describe('13 · OW-1: an applied receipt latches the scenario — then nothing is registered over it', { timeout: 30_000 }, () => {
