...
interface CanvasToolbarProps {
  /** Run analysis callback (wired from parent) */
  onRun?: () => void | Promise<void>
}

export function CanvasToolbar({ onRun }: CanvasToolbarProps = {}) {
      ...
      >
        ...
        {onRun && (
          <button
            ...
            className="px-3 py-1.5 text-sm font-medium text-white bg-[#EA7B4B] rounded-lg hover:bg-[#EA7B4B]/90 transition-colors focus:outline-none focus:ring-2 focus:ring-[#EA7B4B] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5"
            title="Run analysis (⌘⏎ or via ⌘K → 'Run Analysis')"
            aria-label="Run analysis"
            data-testid="btn-run-analysis-global"
          >
