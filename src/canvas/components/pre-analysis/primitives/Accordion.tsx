  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full px-3 py-3 bg-panel flex items-center justify-between hover:bg-panel-hover transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-info focus-visible:ring-inset"
      >
