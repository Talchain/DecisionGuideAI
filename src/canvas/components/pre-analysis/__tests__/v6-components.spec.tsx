 ...
 * Covers: ModelHealthCard, DraftNotes, deriveExpertiseGroups, hasFeasibilityWarning.
 * (KeyRelationshipsSubgroup and EdgeEvidenceGaps removed in D7 — expertise directory deleted.)
 */
