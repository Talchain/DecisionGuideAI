...
export function InlineEdit({
  ...
  return (
    <span
      ...
      className={`inline-flex items-center gap-0.5 cursor-pointer rounded-md border ${flashSuccess ? 'border-success duration-[600ms]' : 'border-panel-border duration-150'} bg-panel px-2 py-0.5 hover:border-info transition-colors`}
