...
export function ReconnectBanner() {
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 text-white px-4 py-2 rounded shadow-panel z-50 bg-info-500" role="alert" aria-live="assertive" data-testid="banner-reconnect-mode">
