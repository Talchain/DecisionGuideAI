...
const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    description:
      'Frame → Challenge → Analyse → Learn. Olumi turns messy strategic work into a living visual model while keeping your judgement visible.',
    icon: <Sparkles className="w-8 h-8 text-info" aria-hidden="true" />,
    bullets: [
      'Ask Olumi to structure goals, options, risks, evidence, assumptions, and outcomes.',
      'Inspect the model to understand causal links, uncertainty and provenance.',
      'Use the Model tab for supported factor changes, then rerun to see what moved.',
    ],
  },
  {
    id: 'templates',
    ...
    description:
      'Semantic changes go through Olumi or a supported Model action so analysis and reload use the same model you see.',
    icon: <Layers className="w-8 h-8 text-option" aria-hidden="true" />,
    bullets: [
      'Olumi stages structural changes for confirmation before applying them.',
      'Supported factor changes show what will change before you confirm.',
      'Read-only details stay available without pretending a browser-only edit was saved.',
    ],
  },
  {
    id: 'save',
    ...
    description:
      'Olumi marks analysis stale when an accepted model change means the answer should be rerun.',
    icon: <Save className="w-8 h-8 text-success" aria-hidden="true" />,
    bullets: [
      'Accepted model changes are checked against the shared scenario before success is shown.',
      'Presentation changes such as layout do not claim to alter the analysis.',
      'Reload is the final check that a model change really persisted.',
    ],
  },
  {
    id: 'editing',
    title: 'Refine with confidence',
    description: 'Move fluidly between the canvas, Model, analysis and Olumi without losing model authority.',
    icon: <Edit3 className="w-8 h-8 text-warning" aria-hidden="true" />,
    bullets: [
      'Open an edge to inspect its current strength, confidence and provenance.',
      'Use the Model tab for supported factor values.',
      'Ask Olumi for structural changes and confirm the exact proposal before it is applied.',
    ],
  },
  {
    id: 'analyse',
