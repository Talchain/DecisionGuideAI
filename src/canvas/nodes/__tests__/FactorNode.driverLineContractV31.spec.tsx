 ...
 *
 * ⭐ PT 5 GOVERNS AGAIN (design-gap row 39, reversing ED #63 5806207128's
 * `Driver N of M analysed`): the ranked caption is `Driver N of M ranked in
 * this run` (stale `Last run · Driver N of M ranked`), M = the factors the run
 * RANKED. The unranked half of pt 5 (no line, "Not ranked in this run" to AT)
 * stands.
 *
 ...
 * so a caption that prints the analysed set goes red.
 *
...
describe('v3.1 pt 5 (row 39) — a RANKED factor reads "Driver N of M ranked in this run", M = the factors the run ranked', () => {
