...
describe('Render matrix — DecisionNode chip audit', () => {
  ...
  it('Standard pre: shows "Explore more options" + ("Run analysis" XOR "What could go wrong?") — never 3 chips', () => {
    ...
    // — "coaching behind the one icon" (ED 11:52Z point 1). The pre-analysis
    // chip row left the Standard face (Detailed keeps it, pinned below); the
    // rail's coaching icon asks "Explore more options", and "Run analysis" is a
    // rail ACTION (`decision-run-analysis-<id>`), never a face chip.
  ...
  it('Standard post: shows "Challenge this result" + "Compare options"', () => {
    ...
    // the Standard face (ED 11:52Z point 1); with a licensed robustness verdict
    // the popover carries the verdict, so "Compare options" lives in Detailed.
    const face = faceOf('Hiring decision')
