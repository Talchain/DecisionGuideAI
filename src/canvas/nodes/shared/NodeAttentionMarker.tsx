  ...
  return (
    <Tooltip asChild delay={NODE_TOOLTIP_DELAY_MS} content={sentence}>
      <button
        ...
        className={`nodrag nopan shrink-0 inline-flex items-center justify-center rounded text-info hover:bg-info/10 focus-visible:bg-info/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-info ${CANVAS_GLYPH_SIZE_CLASSES[CANVAS_QUICK_ACTION_BOX_PX]}`}
      >
        <LocateFixed
          aria-hidden="true"
