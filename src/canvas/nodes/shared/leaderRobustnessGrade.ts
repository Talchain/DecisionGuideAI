...
export function leaderRobustnessGrade(report: unknown): LeaderRobustnessGrade | null {
  ...
  return {
    ...
    title:
      level === 'very_low'
        ? 'Highly sensitive: which option the data supports changed often across the scenarios we sampled. Small changes could shift it.'
        : 'Sensitive: which option the data supports changed across some of the scenarios we sampled. Small changes could shift it.',
  }
}
