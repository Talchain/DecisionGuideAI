...
export default function OnboardingHints() {
  ...
  return (
    <div className="absolute top-20 left-1/2 transform -translate-x-1/2 z-30 max-w-md">
      <div className="bg-gradient-to-br from-indigo-50 to-blue-50 border-2 border-info/30 rounded-lg shadow-xl p-4">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          <button
            onClick={handleDismiss}
            className="px-3 py-1 bg-primary text-text-on-color rounded hover:bg-primary-hover transition-colors font-medium"
          >
            Got it!
          </button>
        </div>
