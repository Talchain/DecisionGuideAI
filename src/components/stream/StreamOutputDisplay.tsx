 ...
 *
 * SECURITY: The mdHtml prop uses dangerouslySetInnerHTML. All callers MUST pass
 * HTML that was generated by renderMarkdownSafe() or equivalent sanitization.
 * The SafeHtml branded type enforces this contract at the type level.
 */
...
/**
 * Branded type for HTML that has been sanitized.
 * Use createSafeHtml() to create instances from sanitized sources.
 *
 * SECURITY: Only pass HTML that was generated by renderMarkdownSafe() or
 * sanitizeMarkdown() from @/lib/renderSafeRichText.
 */
export type SafeHtml = string & { readonly __safeHtml: unique symbol }

/**
 * Create a SafeHtml value from sanitized HTML.
 * ONLY use this with output from renderMarkdownSafe() or sanitizeMarkdown().
 */
...
interface StreamOutputProps {
  ...
  /**
   * Pre-sanitized HTML for markdown preview.
   * SECURITY: Must be output from renderMarkdownSafe() or sanitizeMarkdown().
   * Use SafeHtml type for type-safe enforcement.
   */
  mdHtml?: string | SafeHtml
  mdEnabled?: boolean
