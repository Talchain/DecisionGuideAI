...
const RANKING = {
  resolved: [{ factorId: 'fac_market', label: 'Market receptivity', canFocus: true, valueAffordance: 'none' as const }],
  belowResolution: [{ factorId: 'fac_brand', label: 'Brand halo', canFocus: false, valueAffordance: 'none' as const }],
