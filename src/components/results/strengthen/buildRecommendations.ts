  ...
  if (inputs.goalThreshold == null) {
    recs.push({
      ...
      action: {
        ...
        message: 'Help me define what success looks like for this decision.',
      },
      targetId: null,
  ...
  if (inputs.analysisComplete && inputs.fragileEdges.length > 0) {
    ...
    recs.push({
      ...
      action: {
        ...
        message: `Help me plan an evidence check for the relationship involving ${top.factorLabel}.`,
      },
      targetId: top.edgeId,
    ...
    if (top) {
      ...
      recs.push({
        ...
        action: {
          ...
          message: `Help me plan a quick investigation into ${top.label}.`,
        },
  ...
  if (inputs.analysisComplete && (level === 'low' || level === 'very_low')) {
    recs.push({
      ...
      action: {
        ...
        message: 'Build the strongest case against the current leading option.',
      },
      targetId: null,
  ...
  if (inputs.biasFindingTypes.some((t) => NARROW_TYPES.includes(t))) {
    recs.push({
      ...
      action: {
        ...
        message: 'Suggest one materially different option that works through a different mechanism.',
      },
      targetId: null,
  ...
  if (
    ...
    recs.push({
      ...
      action: {
        ...
        message: 'Help me record this decision, its key assumptions, and what would trigger a rethink.',
      },
      targetId: null,
