...
import type { AnalysisRequestIdChain, DraftGraphTrace } from '@talchain/schemas'

/**
 * Analysis flow: UI → PLoT → ISL (hard invariant — mismatches cause fail)
 * Re-exported from @talchain/schemas as AnalysisRequestIdChain.
 */
export type AnalysisChain = AnalysisRequestIdChain
...
export interface RequestIdChain {
  ...
  analysis_chain: AnalysisRequestIdChain
