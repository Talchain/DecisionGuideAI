...
export default defineConfig({
  ...
  outputDir: 'test-results/ai-conversation',
  use: { baseURL: `http://localhost:${PORT}`, headless: true, launchOptions: process.env.PW_CHROMIUM_PATH ? { executablePath: process.env.PW_CHROMIUM_PATH } : undefined, trace: 'off', video: 'off', screenshot: 'off', deviceScaleFactor: 1 },
