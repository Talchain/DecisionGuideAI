/*
  ...
  1. New Functions
    - `send_email_with_template`: Core function to send emails using Brevo API
    - `test_email_sending`: Function to test email sending functionality
    - `send_team_invitation_email`: Function for sending team invitations

  2. Email Templates
    - Adds default templates for test emails and team invitations
*/
