/*
  # Create Default Organizations for Existing Data

  1. Data Migration Strategy
    - Create a default organization for each existing user who has teams or decisions
    - Associate all existing teams with their creator's default organization
    - Associate all existing decisions with their creator's default organization
    - Update team_id references where missing

  2. Migration Steps
    - Create default organizations for users with existing data
    - Update teams table with organisation_id
    - Update decisions table with organisation_id and team_id
    - Update other core tables with organisation_id
