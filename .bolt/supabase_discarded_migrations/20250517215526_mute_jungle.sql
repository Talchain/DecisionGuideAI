...
DROP FUNCTION IF EXISTS public.send_email_with_template;
DROP FUNCTION IF EXISTS public.test_email_sending;
DROP FUNCTION IF EXISTS public.send_team_invitation_email;
