...
2. Email Templates
  - Creates default email templates for testing and team invitations

3. Security
  - All functions are SECURITY DEFINER to ensure proper access control
  - Execute permissions granted to both authenticated and anonymous users
*/

-- Drop existing functions to avoid "function not unique" errors
