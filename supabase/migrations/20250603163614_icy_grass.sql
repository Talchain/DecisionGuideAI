/*
  # Add Collaborative Criteria Tables
  
  1. New Tables
    - criteria_suggestions: Stores proposed criteria from team members
    - criteria_comments: Enables discussion on criteria suggestions  
    - criteria_votes: Tracks votes on suggested criteria

  2. Security
    - Enable RLS on all tables
    - Add policies for proper access control
    - Ensure collaborators can only access their decisions
