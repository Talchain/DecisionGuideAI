/*
  # Organization RPC Functions
  
  1. New Functions
    - `get_organisation_details`: Fetches details for a single organization
    - `get_organisation_members`: Retrieves members of a specific organization
    - `get_organisation_teams`: Fetches teams belonging to an organization
    - `check_organisation_slug_exists`: Validates if a slug is already in use
    - `track_invitation_status`: Logs the status of email invitations
