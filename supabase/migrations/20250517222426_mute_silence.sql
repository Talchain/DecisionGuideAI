-- First, drop all existing functions with these names regardless of parameter types
DROP FUNCTION IF EXISTS public.send_email_with_template(TEXT, TEXT, TEXT, JSONB) CASCADE;
DROP FUNCTION IF EXISTS public.test_email_sending(TEXT) CASCADE;
DROP FUNCTION IF EXISTS public.send_team_invitation_email(UUID, TEXT, TEXT, TEXT, TEXT) CASCADE;
...
-- Function to send team invitation email with explicit parameter types
