...
**Restart checkpoint, 9 September 2026:** [preserved work, deployed changes and remaining acceptance](RESTART-CHECKPOINT-20260909.md). This is the option track’s record; the programme entry point remains `output/olumi-handover-20260907-2045/START-HERE.md` in the GitHub workspace. New implementation and prototype work are on hold.
...
- The sheet simulates the earlier read-only inspector. Subsequent application releases #1345/#1359 activate canonical option-value editing, and #1365 supplies the restore acknowledgement; these later behaviours are not demonstrated by this historical sheet. Header rename is simulated locally. The restored-model save journey still needs deployed acceptance.
...
The original independent Canvas review is retained in [the #1333 review brief](https://github.com/Talchain/DecisionGuideAI/pull/1333#issuecomment-5592283113); later reviews and releases are in the validation record. Current coordination and restart ACKs use [programme #38](https://github.com/Talchain/olumi-programme-docs/pull/38). Paul and the established Codex/Canvas pair retain design ownership. No competing prototype edits are requested.
