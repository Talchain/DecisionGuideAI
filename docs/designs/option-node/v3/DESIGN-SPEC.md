...
| G03 | Comparative vocabulary, leading-badge reservation and actual question framing | Canvas: [#1310](https://github.com/Talchain/DecisionGuideAI/pull/1310), [#1219](https://github.com/Talchain/DecisionGuideAI/pull/1219) where applicable | Canvas owns the remaining question framing, vocabulary and badge reservation. The separate comparative coaching-message repair [#1356](https://github.com/Talchain/DecisionGuideAI/pull/1356) is source-clear and awaits hosted checks; it does not close question framing. |
