...
| O05 | Explicit missing result; preserve measured zero and existing failure/currentness | Option Codex #1342 and `codex/option-result-currentness` | Missing/zero/failed repair deployed; retained-result freshness qualification under review. No new browser witness. |
