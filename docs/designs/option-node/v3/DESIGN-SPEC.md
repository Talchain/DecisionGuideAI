...
| G03 | Comparative vocabulary, leading-badge reservation and actual question framing | Canvas: [#1310](https://github.com/Talchain/DecisionGuideAI/pull/1310), [#1219](https://github.com/Talchain/DecisionGuideAI/pull/1219) where applicable | Canvas owns the remaining question framing, vocabulary and badge reservation. The separate comparative coaching-message repair [#1356](https://github.com/Talchain/DecisionGuideAI/pull/1356) passed its hosted gate and is served as `b61ae1fe`; it does not close question framing. |
...
| G06 | Factor influence/edge certainty/strength copy, path dimming and badge readability | Canvas, including [#1344](https://github.com/Talchain/DecisionGuideAI/pull/1344) | Evidence/measurement coaching and static evidence-gap warning deployed as `ee2b241f`. Shared metric hover/focus disclosure is [#1357](https://github.com/Talchain/DecisionGuideAI/pull/1357), owned by Option Codex and under review/hosted checks. Its data and scale semantics are unchanged. Graph framing remains open; existing framing tests stay active. |
