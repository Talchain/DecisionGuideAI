...
| O05 | Explicit missing result; preserve measured zero and existing failure/currentness | Option Codex #1342 and #1353 | Missing/zero/failed repair deployed; retained-result freshness qualification deployed in #1353 as `10d060f2`. No new currentness browser witness. |
...
| O08 | Compact read-only inspector; neutral deltas and truthful edit affordances | Canvas [#1355](https://github.com/Talchain/DecisionGuideAI/pull/1355) | Independently reviewed and deployed as `78202540`: concise notice, explicit model values, readable read-only targets, description identity and usable navigation alongside fenced writes. Runtime inspect/rename/navigation/AI checks required. |
...
| G03 | Comparative vocabulary, leading-badge reservation and actual question framing | Canvas; [#1310](https://github.com/Talchain/DecisionGuideAI/pull/1310) closed, [#1219](https://github.com/Talchain/DecisionGuideAI/pull/1219) where applicable | Canvas owns the remaining question framing and badge reservation. #1310 was closed to preserve the existing non-contest wording; that closure does not resolve question framing or explain the metric. The separate comparative coaching-message repair [#1356](https://github.com/Talchain/DecisionGuideAI/pull/1356) passed its hosted gate and is served as `b61ae1fe`. |
