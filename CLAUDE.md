...
| UI-SEM-045 | `src/components/results/DriversSection.tsx` (rank-flip warning) | Rank-flip warning visibility gate (`rankFlipRate >= 0.15`) | Remove when PLoT provides visibility gate. (Ledger corrected 2026-07-14 — threshold was 0.3, is now 0.15; source re-tagged) |
