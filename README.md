...
## Local Preview - Whiteboard with Templates Panel
...
The browser will open to **http://localhost:5173/#/canvas**

### Smoke Checklist

After the Canvas loads, verify:

- ✅ **Whiteboard** visible as the main surface (React Flow graph editor)
- ✅ **Templates Button** in top-right corner
- ✅ **Build Badge** in top-left showing commit and mode

**Open Templates Panel:**
1. Click "Templates" button (top-right)
2. Panel slides in from the right (desktop) or bottom (mobile)
3. Verify:
   - ✅ Panel header shows "Templates" with close button
   - ✅ "Show dev controls" toggle (off by default)

**Enable Dev Controls:**
1. Toggle "Show dev controls" switch
2. Yellow dev section appears with:
...
- **Main Surface**: React Flow whiteboard (`CanvasMVP`)
- **Panel**: Templates panel (lazy-loaded, `TemplatesPanel`)
...
**Panel Behavior:**
- **Desktop (≥1024px)**: Fixed right drawer (360-420px width)
